<template>
    <div class="suit p11">
        <img src="https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/西装.png" alt="" class="full">
        ...
        <img src="https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/新品.png" alt="" class="full" @click="goAlbum('未标题-1_{{}}.jpg',10)">
        ...
        <div class="suit-module" @click="goAlbum('设计师介绍750-1000/未标题-2_{{}}.jpg',3)">
            ...
            <img src="https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/设计师介绍.png" alt="" class="full">
        </div>
        <div class="suit-module" @click="goAlbum('男士西装品牌简介750-1000/未标题-2_{{}}.jpg',8)">
            <div class="suit-module-title">品牌简介</div>
            <img src="https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/品牌简介.png" alt="" class="full">
        </div>
        <div class="suit-module" @click="goAlbum('门店介绍750-1000/未标题-2_{{}}.jpg',6)">
            <div class="suit-module-title">门店介绍</div>
            <img src="https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/门店介绍.png" alt="" class="full">
        </div>
...
<script>
    export default {
        ...
        data() {
            return {
                img: {
                    littleImg: "https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/西装小图.png",
                    bigImg: "https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/西装大图.png",
                    index: 0,
                },
                imgList: [
                    {
                        littleImg:"https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/西装小图2.png",
                        bigImg:"https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/西装大图.png",
                        index: 1,
                    },
                    {
                        littleImg:"https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/西装小图3.png",
                        bigImg: "https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/西装大图3.png",
                        index: 2,
                    },
                    {
                        littleImg: "https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/西装小图4.png",
                        bigImg: "https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/西装大图4.png",
                        index: 0,
                    },
                ],
                list: [
                    {
                        img:"https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/南柱赫系列8980.png",
                        detailName:"4南柱赫系列官方案例/未标题-1_{{}}.jpg",
                        detailNumber:9
                    },
                    {
                        img:"https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/朴炯植系列6980.png",
                        detailName:"5朴炯植系列官方案例/未标题-1_{{}}.jpg",
                        detailNumber:5
                    },
                    {
                        img:"https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/朴叙俊明星系列6980.png",
                        detailName:"3朴叙俊·明星系列官方案例/未标题-1_{{}}.jpg",
                        detailNumber:11
                    },
                    {
                        img:"https://apptopgalleria.oss-cn-shanghai.aliyuncs.com/img/张东健系列8980.png",
