(function($){
    ...
    if (userTemplateID == null && previewid === null && shareid === null) {
      ...
      $(document).on("click", ".preview_icon", function () {
          var url = helpClass.prodUrl + "card2/index.html?previewid=" + userTemplateID;
          var shareurl = helpClass.prodUrl + "card2/index.html?shareid=" + userTemplateID;
          console.log(url)
      ...
      // 编辑文字
        ...
        $(".sending_btns").click(function () {
            hosts({
                ...
                function (res) {
                    console.log(res);
                    var url = helpClass.prodUrl + "card2/index.html?shareid=" + userTemplateID;
                    // console.log(content)
                     console.log(url)
                    // console.log(title)
