...
class StoreCombination extends AuthController
{
    ...
    public function save_attr()
    {
        ...
        $combinationId = StoreCombinationModel::where('id', $data['id'])->value('product_id');
        $attr = json_decode(StoreProductAttrResult::where('product_id', $combinationId)->value('result'), true)['attr'];
