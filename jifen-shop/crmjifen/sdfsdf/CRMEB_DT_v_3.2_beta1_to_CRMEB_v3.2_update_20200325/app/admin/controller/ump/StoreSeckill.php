...
//        $time = StoreSeckillTime::getSeckillTime($id);
    ...
    public function save_attr()
    {
        ...
        $seckillId = StoreSeckillModel::where('id', $data['id'])->value('product_id');
        $attr = json_decode(StoreProductAttrResult::where('product_id', $seckillId)->value('result'), true)['attr'];
