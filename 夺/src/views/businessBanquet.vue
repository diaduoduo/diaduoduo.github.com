<template>
    <div class="businessBanquet">
        <img src="https://apptopgalleria2.oss-cn-shanghai.aliyuncs.com/img/商务宴.png" alt="" class="full">
    ...
    export default {
        ...
        data(){
            return{
                list:[],
                imgList:[],
                poster:'https://apptopgalleria2.oss-cn-shanghai.aliyuncs.com/img/商务宴aa.png'
            }
        },
        methods:{
            getInfo:function(){
